...
# data = pd.read_pickle('./data/cleanData/cleanFactors_gtja191_20220204.pkl')
look_back_num = 10
...
with open(f'./data/cnnData/axis1Time.pkl', 'rb') as file:
    date = pickle.load(file)
cleanData = pd.read_pickle('./data/cleanData/cleanFactors_gtja191_20220204.pkl')

# dates = pd.DataFrame(data['sharedInformation']['axis1Time'], columns=['timestamp'])
dates = pd.DataFrame(date, columns=['timestamp'])
...
for g in groups:
    ...
    with open(f'./data/cnnData/{g}_cnnFactors_gtja191_20220204', 'wb') as file:
